    ...
    <>
      ...
      <div className="d-flex p-2">
        <form>
          ...
          <button type='button' className="btn btn-primary mr-1" onClick={() => { dispatch(actions.add(createNewContact())); }}>
            ADD
          </button>

          <button className="btn btn-warning" onClick={() => { dispatch(actions.change(createNewContact())); }}>
            CHANGE
          </button>
        </form>
      </div>
